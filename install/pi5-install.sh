...
DEFAULT_PACKAGES="musl toybox mksh openrc dhcpcd ifupdown-ng dropbear bsdtar openntpd jonerix-ntp-http-bootstrap sudo python3 anvil raspi-config shadow jonerix-raspi5-fixups iproute-go zsh gitoxide ripgrep pico fastfetch"
...
#   zsh, gitoxide, ripgrep, pico, fastfetch — interactive niceties
